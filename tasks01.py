...
class AINewsLetterTasks():
    def fetch_news_task(self, agent):
        return Task(
            ...
            agent=agent,
            async_execution=True, # Can get 5 stories at the same time
    ...
    def analyze_news_task(self, agent, context):
        return Task(
            ...
            agent=agent,
            async_execution=True, # Can analyse different articles at the same time
            context=context, # Feed the output of the previous task to this task
